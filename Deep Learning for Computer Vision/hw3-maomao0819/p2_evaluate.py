...
def evaluation(predictions, annotations, images_root):
...
def main(args):
    ...
    evaluation(predictions, annotations, args.images_root)


if __name__ == "__main__":
    parser = ArgumentParser()

    parser.add_argument("--pred_file", default="image_caption_prediction.json", help="Prediction json file")
