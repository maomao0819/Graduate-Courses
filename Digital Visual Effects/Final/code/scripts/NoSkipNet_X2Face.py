...
def define_G(input_nc, output_nc, ngf, which_model_netG, norm='batch', use_dropout=False, init_type='normal', gpu_ids=[], inner_nc=512):
    ...
    if which_model_netG == 'unet_128':
        ...
        netG = UnetGeneratorBetterUpsampler(input_nc, output_nc, 7, ngf, inner_nc=inner_nc,
                                            norm_layer=norm_layer, use_dropout=use_dropout, gpu_ids=gpu_ids)
    elif which_model_netG == 'unet_256':
        netG = UnetGeneratorBetterUpsampler(input_nc, output_nc, 8, ngf, inner_nc=inner_nc,
                                            norm_layer=norm_layer, use_dropout=use_dropout, gpu_ids=gpu_ids)
...
class Pix2PixModel(nn.Module):
    def __init__(self, input_nc, output_nc, inner_nc=512, no_skip_net_backbone='unet_128'):
        super(Pix2PixModel, self).__init__()

        self.netG = define_G(input_nc, output_nc, 64, no_skip_net_backbone, 'batch', False, 'xavier', [0], inner_nc=inner_nc)
...
class UnetGeneratorBetterUpsampler(nn.Module):
    def __init__(self, input_nc, output_nc, num_downs, ngf=64, inner_nc=512,
        ...
        unet_block = UnetSkipConnectionBlockBetterUpsampler(
            ngf * 8, inner_nc, input_nc=None, submodule=None, norm_layer=norm_layer, innermost=True)
