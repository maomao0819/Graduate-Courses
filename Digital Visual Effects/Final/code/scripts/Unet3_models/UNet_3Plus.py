...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        # down
        self.downconv1 = unetConv2(filters[4], filters[3], self.is_batchnorm, stride=2)
        self.downmaxpool1 = nn.MaxPool2d(kernel_size=2)
    ...
    def forward(self, inputs):
        ...
        down1 = self.downmaxpool1(self.downconv1(hd5))
